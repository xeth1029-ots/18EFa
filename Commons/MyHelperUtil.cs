...
{
    /// <summary>
    /// 放置 Turbo.MVC.Base3 專用的 HelperUtil 擴充,
    ...
    public class MyHelperUtil : Turbo.Commons.HelperUtil
    {
        ...
        {
            bool rst = false;
            if (numStr == null) { return rst; }
            if (string.IsNullOrEmpty(numStr)) { return rst; }
            int a = 0;
            rst = int.TryParse(numStr, out a);
            return rst;
        }
        ...
        public static bool IsEmpty(object @object)
        {
            ...
            if (!"".Equals(@object.ToString().Trim())) { return false; }
            return true;
        }
        ...
        {
            if (s == null || IsEmpty(s)) { return defaultStr; }
