...
$(document).ready(function () {
  ...
  /* owasp A03 Injection; 
   */
});
...
function blockUI() {
  ...
  if ("loadingMask" != $(mask).attr("id")) {
    ...
    $(img).attr("alt", globalSetting.processingalt);
    $(mask).append(img);
    $("body").append(mask);
  }
...
function blockMessage(msg, title, unblockCallback) {
  ...
  $.confirm({
    ...
    title: "<span class='blockMessageTitle'>" + (title ? title : '提示訊息') + "</span>",
    confirmButton: '確定',
...
function blockWarning(msg, title, unblockCallback) {
  /* required: jqiuer-confirm.min.js */
  if (msg == undefined) {
    msg = "argument 'msg' is null while call blockMessage()";
  }
...
function blockAlert(msg, title, sureCallback, height) {
  ...
  $.confirm({
    backgroundDismiss: false,
    icon: 'glyphicon glyphicon-warning-sign',
    title: "<span class='blockAlertTitle'>" + (title ? title : '提示訊息') + "</span>",
    confirmButton: '確定',
    confirmButtonClass: 'btn-info',
    cancelButton: false,
    closeIcon: false,
...
function blockConfirm(msg, title, confirmCallback, cancelCallback, confirmBtnText, cancelBtnText) {
  ...
  $.confirm({
    ...
    title: "<span class='blockAlertTitle'>" + (title ? title : '確認訊息') + "</span>",
    confirmButton: (confirmBtnText ? confirmBtnText : "確定"),
    confirmButtonClass: 'btn-info',
    cancelButton: (cancelBtnText ? cancelBtnText : "取消"),
    cancelButtonClass: 'btn-info',
    closeIcon: false,
    content: "<span class='blockAlertMessage' style='width:100%;height:" + wdHeight + ";overflow:auto;word-wrap:break-word;white-space:normal;'>" + msg.replace(/(\n)+/g, '<br />') + "</span>",
    theme: 'white',
...
function popupWindow(windowConfig, contentUrl, title, jsonParam, closeCallback, loadCallback, closeConfirmCallback, shownCallback) {
  try {
    ...
    // 定義載入完成後的處理邏輯-OWASP
    var handleIframeLoad = function (e) {
      try {
    ...
    // 修正 Race Condition：先綁定事件，再檢查是否已載入完成-OWASP
    elmFrame.on("load", handleIframeLoad);
    // 如果 iframe 內容在綁定前就已經 Ready (例如快取)，主動觸發處理程序-OWASP
    if (elmFrame[0].contentDocument && elmFrame[0].contentDocument.readyState === 'complete') {
      handleIframeLoad();
    }
